                    ...
                    <div className="flex flex-col gap-3 sm:flex-row sm:justify-between">
                        ...
                        <div className="relative max-w-full sm:max-w-xs">
                            ...
                            <input
                                ...
                                className="py-2 px-3 ps-9 block w-full border-gray-200 shadow-sm rounded-lg text-sm focus:z-10 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"
                ...
                <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            ...
                            <th scope="col" className="px-6 py-3">Property Number</th>
                        ...
                        {isLoading ? (
                            ...
                            currentData.map((supply, index) => (
                                ...
                                >
                                    ...
                                    <td className=" border border-red-500 px-6 py-4">
                                        <DeteleSupply />
